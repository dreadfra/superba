...
/**
 * Includo un file contenente le funzioni di utilità per il tema.
 */
require_once dirname( __FILE__ ) . '/custom/helpers.php';

/**
 * Includo la configurazione del custom post type "gare".
 */
require_once dirname( __FILE__ ) . '/custom/gare/gare.php';

/**
 * Includo la configurazione del custom post type "corridori".
 */
require_once dirname( __FILE__ ) . '/custom/corridori/corridore.php';

/**
 * Includo la configurazione del custom post type "gallery".
 */
require_once dirname( __FILE__ ) . '/custom/gallery/gallery.php';
